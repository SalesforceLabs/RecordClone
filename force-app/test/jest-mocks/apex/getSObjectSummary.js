...
const sObjectSummaryResult = {
  ...
  children: [
    {
      ...
      fields: [
        ...
        {
          apiName: "Discount",
          errorMessage: "NOT_ACCESSIBLE,NOT_CREATEABLE",
          isClonable: false,
          label: "割引"
        },
        {
        ...
        {
          apiName: "CreatedDate",
          errorMessage: "NOT_CREATEABLE,IS_EXCLUDED",
          isClonable: false,
          label: "作成日"
        },
        {
  ...
  fields: [
    ...
    { apiName: "Name", errorMessage: "", isClonable: true, label: "商談名" },
    {
      apiName: "Description",
      errorMessage: "",
      isClonable: true,
    ...
    { apiName: "Amount", errorMessage: "", isClonable: true, label: "金額" },
    {
      apiName: "Probability",
      errorMessage: "",
      isClonable: true,
...
export default sObjectSummaryResult;
